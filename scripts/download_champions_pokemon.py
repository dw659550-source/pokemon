...
CHAMPIONS_LIST = [
    ...
    ("tauros",               "ケンタロス",            "tauros"),
    ("tauros-paldea-combat", "ケンタロス(パルデア単)", "tauros-paldea-combat-breed"),
    ("tauros-paldea-blaze",  "ケンタロス(パルデア炎)", "tauros-paldea-blaze-breed"),
    ("tauros-paldea-aqua",   "ケンタロス(パルデア水)", "tauros-paldea-aqua-breed"),
    ...
    ("gourgeist",            "パンプジン",            "gourgeist-average"),
    ...
    ("mimikyu",              "ミミッキュ",            "mimikyu-disguised"),
    ...
    ("morpeko",              "モルペコ",             "morpeko-full-belly"),
    ...
    ("maushold",             "イッカネズミ",           "maushold-family-of-four"),
    ...
    ("palafin",              "イルカマン(ナイーブ)",    "palafin-zero"),
