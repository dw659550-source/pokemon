...
_MOVE_JA: dict[str, str] = {}   # ja_name → key
_ITEM_JA: dict[str, str] = {}   # ja_name → key
_POKE_JA: dict[str, str] = {}   # ja_name → key
...
def _parse_by_class(soup, result: dict):
    ...
    # クラス名に move/item/partner が含まれる要素
    CLASS_CAT = [
